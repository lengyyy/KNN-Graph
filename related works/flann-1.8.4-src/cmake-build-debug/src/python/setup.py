...
def find_path():
    lib_paths = [ os.path.abspath('C:/Users/markz/Desktop/KNN-Graph/KNN-Graph/related works/flann-1.8.4-src/cmake-build-debug/lib'), abspath(join(dirname(dirname(sys.argv[0])), '../../../lib')) ]
